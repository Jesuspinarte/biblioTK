...
insert into biblioteca values (2, 'Virgilio Barco');

insert into empleado( id, username, password, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, credentials_Non_Expired, enabled, rol, empleador_id ) values (3, 'admin', '123', 0, 0, 0, 0, 0, 1 ); 
insert into empleado( id, username, password, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, credentials_Non_Expired, enabled, rol, empleador_id ) values (4, 'otro', 'otro', 0, 0, 0, 0, 1, 1 ); 

insert into libro ( id, nombre, isbn, autores, prestado, despensa_id ) VALUES ( 5, 'IT', '100-100' , 'Stephen King', 0, 2 );
insert into libro ( id, nombre, isbn, autores, prestado, despensa_id ) VALUES ( 6, 'El Quijote de la Mancha', '1100-080' , 'Miguel de Cervantes',0, 2 );
insert into libro ( id, nombre, isbn, autores, prestado, despensa_id ) VALUES ( 7, 'Asesinato en el Orient Express', '100-0980' , 'Agatha Christie',0, 2 );
